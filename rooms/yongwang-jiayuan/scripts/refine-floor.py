...
project = ROOT / 'rooms/yongwang-jiayuan/assets/full-room/永旺家园-完整场景.blend'
...
(ROOT / 'rooms/yongwang-jiayuan/history/inputs/floor19-geometry-report.json').write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding='utf-8')
