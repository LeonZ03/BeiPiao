...
ROOT=(pathlib.Path(__file__).resolve().parents[3] / 'room-site')
OUT=ROOT/'dist/assets/refined-props'; OUT.mkdir(parents=True,exist_ok=True)
SOURCE=ROOT.parent/'rooms/yongwang-jiayuan/assets/refined-props'; SOURCE.mkdir(parents=True,exist_ok=True)
