...
source=json.loads((root/'analysis/viewer26-head-points.json').read_text())
...
bpy.ops.wm.open_mainfile(filepath=str(root/'generated-assets/shelf-gundam/shelf-gundam.blend'))
bpy.context.view_layer.update()
...
bpy.ops.wm.save_as_mainfile(filepath=str(root/'generated-assets/shelf-gundam/shelf-gundam.blend'))
