...
| 柜门：木柜门吱响 | [Door Creak — brunoboselli](https://freesound.org/people/brunoboselli/sounds/478600/) |
...
三段素材合计约 0.94 MB，仅在用户取消静音后加载；水流使用持续循环声源，开关关闭时淡出，不重新播放启停片段。柜门声仅在实际运动期间播放。
